...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687212741
export GCC_IGNORE_WERROR=1
export AR=gcc-ar
export RANLIB=gcc-ranlib
export NM=gcc-nm
export CFLAGS="$CFLAGS -O3 -fdebug-types-section -femit-struct-debug-baseonly -ffast-math -ffat-lto-objects -flto=auto -ftree-loop-vectorize -g1 -gno-column-info -gno-variable-location-views -gz=zstd "
export FCFLAGS="$FFLAGS -O3 -fdebug-types-section -femit-struct-debug-baseonly -ffast-math -ffat-lto-objects -flto=auto -ftree-loop-vectorize -g1 -gno-column-info -gno-variable-location-views -gz=zstd "
export FFLAGS="$FFLAGS -O3 -fdebug-types-section -femit-struct-debug-baseonly -ffast-math -ffat-lto-objects -flto=auto -ftree-loop-vectorize -g1 -gno-column-info -gno-variable-location-views -gz=zstd "
export CXXFLAGS="$CXXFLAGS -O3 -fdebug-types-section -femit-struct-debug-baseonly -ffast-math -ffat-lto-objects -flto=auto -ftree-loop-vectorize -g1 -gno-column-info -gno-variable-location-views -gz=zstd "
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libvorbis.so.0.4.9
/V3/usr/lib64/libvorbisenc.so.2.0.12
/V3/usr/lib64/libvorbisfile.so.3.3.8
/V4/usr/lib64/libvorbis.so.0.4.9
/V4/usr/lib64/libvorbisenc.so.2.0.12
/V4/usr/lib64/libvorbisfile.so.3.3.8
